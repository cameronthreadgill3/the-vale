...
### Tenth sticky quest — The Green Gate Keeps

After *The Wharf Answers* completes, Rook starts **The Green Gate Keeps** (`ensureGreenGateAfterWharf`): Nightglass answered — take the green gate, name what hunts beyond it, and bring its measure home.

1. **Use** the existing Thornreach → **Verdant Spine** gate (reach / travel / stand)
2. **Identify** 1 **Gorse Fox** (`gorse-fox`) on Verdant Spine (near-field look / Name · Rank)
3. **Defeat** 1 Gorse Fox on Verdant Spine
4. Return through the gate and report to **Rook**

Rewards: ~75g + ~150 combat XP + shielding skill XP. Yellow arrow: Verdant Spine gate → nearest Gorse Fox on Verdant Spine → return gate → Rook. Reuses existing gates and fauna — no new geometry. First Story Accession texture only — Survive · Learn · Progress. No Lucas transplant.

### Eleventh sticky quest — The Spine Remembers

After *The Green Gate Keeps* completes, Rook starts **The Spine Remembers** (`ensureSpineAfterGreenGate`): the green gate kept its fox measure — walk the Verdant Spine ridge itself, name the soft ash-vole that shares the fox's ground, quiet one bark-hound packing the spine, and bring the ridge's word home.

1. **Reach** Verdant Spine overworld via the Thornreach → **Verdant Spine** gate (travel / stand / arrive)
2. **Identify** 1 **Ash-vole** (`ash-vole`) on Verdant Spine (near-field look / Name · Rank)
3. **Defeat** 1 **Bark Hound** (`bark-hound`) on Verdant Spine
4. Return through the gate and report to **Rook**
...
### Thirteenth sticky quest — The Ashen Gate Opens

After *The Pale Gate Opens* completes, Rook starts **The Ashen Gate Opens** (`ensureAshenAfterPale`): the pale measure is home — walk the ashen gate beyond the pale, take the Ash Pilgrim's word, name the hound that packs the cinder steppe, quiet one needle-rat there, and bring the ashen measure home.

1. **Reach** Ashen Marches overworld via the Pale Wastes → **Ashen Marches** gate (Thornreach → Ashen Marches also accepted)
2. **Talk** to the **Ash Pilgrim** (`ash-pilgrim`) on Ashen Marches
3. **Identify** 1 **Bark Hound** (`bark-hound`) on Ashen Marches (near-field look / Name · Rank)
4. **Defeat** 1 **Needle Rat** (`needle-rat`) on Ashen Marches
5. Return through the gate(s) and report to **Rook**

Rewards: ~90g + ~180 combat XP + shielding skill XP. Yellow arrow: Pale Wastes ashen gate (or Thornreach ashen gate if not on pale) → Ash Pilgrim → nearest Bark Hound on Ashen Marches → nearest Needle Rat on Ashen Marches → return gate(s) → Rook. Reuses existing gates, folk, and fauna (bark-hound / needle-rat pads while sticky) — no new geometry. First Story Accession texture only — Survive · Learn · Progress. No Lucas transplant.

### Fourteenth sticky quest — The Embercoil Gate Opens

After *The Ashen Gate Opens* completes, Rook starts **The Embercoil Gate Opens** (`ensureEmbercoilAfterAshen`): the ashen measure is home — walk the slag gate beyond the marches, name the needle-rat that skitters the coil ridges, quiet one bark-hound packing the heat, and bring the ember measure home.

1. **Reach** Embercoil overworld via the Ashen Marches → **Embercoil** gate (Pale Wastes → Embercoil also accepted)
2. **Identify** 1 **Needle Rat** (`needle-rat`) on Embercoil (near-field look / Name · Rank)
3. **Defeat** 1 **Bark Hound** (`bark-hound`) on Embercoil
4. Return through the gate(s) and report to **Rook**
