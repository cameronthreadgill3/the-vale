...
1. **Quest arrow + HUD line** — Active sticky quests show a yellow edge/on-screen arrow toward the current objective (cairns, hollow entrance, Shade Wisp, Needle Rat, Bark Hound, Mistmere gate, Old Reed, or Rook) plus a HUD line like `→ Identify Needle Rat · 12 tiles`.
