...
export function BankPanel({
  ...
  return (
    <div className="vale-panel pointer-events-auto absolute bottom-4 left-1/2 z-30 w-[min(100%-2rem,28rem)] -translate-x-1/2 rounded border border-[#2a2e24] bg-[#161812]/96 p-3 shadow-xl backdrop-blur-md max-md:bottom-8 sm:bottom-6">
