/** Ashwood-edge cairns / watch markers for Ashwood Watch. */
...
/** Two stone piles west + north of plaza spawn (~24,18). First Story marks — not Hollow Reach. */
...
export const ASHWOOD_CAIRN_IDS = ASHWOOD_EDGE_CAIRNS.map((c) => c.id);
